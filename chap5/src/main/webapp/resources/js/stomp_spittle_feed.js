...
(function() {
  ...
  client.connect('guest', 'guest', function(frame) {
    return client.subscribe('/topic/spittle_feed', handleSpittle);
  });
  ...
  handleSpittle = function(incoming) {
    ...
    return document.getElementById('spittle-list').appendChild(template.content.childNodes[1]);
  };

}).call(this);

//# sourceMappingURL=stomp_spittle_feed.js.map
